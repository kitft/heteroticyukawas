...
if __name__ ==  '__main__':
    ...
    if train_001m3:
        betamodel_001m3,training_historyBeta_001m3, measure2 = train_and_save_nn_HYM(free_coefficient,linebundleforHYM_001m3,depthBeta,widthBeta,nEpochsBeta,stddev=0.05,bSizes=[64],lRate=lRateBeta,alpha=alphabeta,load_network=False)
    else:
    ...
    if train_0m213:
        betamodel_0m213,training_historyBeta_0m213, measure3 = train_and_save_nn_HYM(free_coefficient,linebundleforHYM_0m213,depthBeta,widthBeta,nEpochsBeta,stddev=0.05,bSizes=[64],lRate=lRateBeta,alpha=alphabeta,load_network=False)
    else:
    ...
    with open('HYM_finding_archs_all_HYM.txt', 'a', newline='') as file:
    ...
    # Open the file in append mode and write the data
    with open('finding_archs.txt', 'a', newline='') as file:
        writer = csv.writer(file)
        writer.writerow(data_to_append)
    exit()
    delete_all_dicts_except('dataEval')
